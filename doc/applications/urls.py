...
from doc.applications.views.grading import(RedirectToNextGradableCrooApplication,
                                           RedirectToNextGradableCrooApplicationForCroo,
                                           GradeCrooApplication,
                                           GradeCrooApplicationForCroo,
...
grade_urlpatterns = patterns(
    ...
    url(r'^croos/for/(?P<croo_pk>[0-9]+)/$', RedirectToNextGradableCrooApplicationForCroo.as_view(), name='next_croo'),
    url(r'^croos/for/(?P<croo_pk>[0-9]+)/(?P<pk>[0-9]+)/$', GradeCrooApplicationForCroo.as_view(), name='croo'),
