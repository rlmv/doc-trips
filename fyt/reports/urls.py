...
urlpatterns = [
    ...
    url(r'^applications/leaders/$', TripLeadersCSV.as_view(), name='leaders'),
    url(r'^applications/croo-members/$', CrooMembersCSV.as_view(), name='croo_members'),
    url(r'^dietary/$', DietaryRestrictions.as_view(), name='dietary'),
    url(r'^gear/requests/$', GearRequests.as_view(), name='gear_requests'),
    url(
        r'^registrations/financial-aid/$',
        FinancialAidCSV.as_view(),
        name='financial_aid',
    ),
    ...
    url(r'^medical/$', MedicalInfo.as_view(), name="medical"),
    ...
    url(
        r'^transport/external/requests/$',
        ExternalBusRequestsCSV.as_view(),
        name='bus_stops',
    ),
    url(
        r'^transport/external/riders/(?P<bus_pk>[0-9]+)/$',
        ExternalBusRidersCSV.as_view(),
        name='bus_riders',
    ),
