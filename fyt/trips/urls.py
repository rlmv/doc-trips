...
template_urlpatterns = [
    ...
    url(r'^(?P<triptemplate_pk>[0-9]+)/upload/file$',
        UploadTripTemplateDocument.as_view(), name='upload_file'),
    url(r'^(?P<triptemplate_pk>[0-9]+)/documents/delete/(?P<pk>[0-9]+)/$',
        TripTemplateDocumentDelete.as_view(), name='document_delete'),
    url(r'^(?P<pk>[0-9]+)/documents/list',
        TripTemplateDocumentList.as_view(), name='document_list'),
]
